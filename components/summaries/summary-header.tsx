      ...
      <div className="space-y-6">
        <div className="flex flex-wrap items-center gap-4">
          ...
          >
            ...
            <span className="text-rose-500 font-semibold">AI Summary</span>
          </Badge>
          <div className=" text-sm  flex items-center gap-1.5 font-semibold text-rose-400">
            <Calendar className="h-4 w-5 text-rose-500" />
