...
export default function LoadingSkeleton() {
  return (
    <div className="w-full flex justify-center">
      <Card className="relative px-2 h-[500px] sm:h-[600px] lg:h-[700px] w-full md:max-w-[600px] overflow-hidden bg-gradient-to-br from-background via-background/95 to-rose-500/5 backdrop-blur-lg shadow-2xl rounded-3xl border border-rose-500/10">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-background/80 backdrop-blur-sm border-t border-rose-500/10">
          <div className="flex justify-between items-center">
            ...
            <Skeleton className="rounded-full w-12 h-12 bg-gradient-to-br from-rose-500/50 to-rose-500/50" />
          </div>
        </div>
      </Card>
    </div>
